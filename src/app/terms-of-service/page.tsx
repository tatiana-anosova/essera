		...
		<div className={clsx('page', styles.page)}>
			<main className={clsx(styles.main)}>
				...
				<div>
					...
					<p>This website is operated by ESSERA. Throughout the site, the terms “we”, “us” and “our” refer to
						ESSERA. ESSERA offers this website, including all information, tools and Services available from
						this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies
				...
				<div>
					...
					<p>Certain products or Services may be available exclusively online through the website. These
						...
						according to our Refund Policy: https://essera.store/policies/refund-policy </p>
				...
				<div>
					...
					<p>For more details, please review our Refund Policy:
						https://essera.store/policies/refund-policy </p>
				</div>
				<div>
					<div className={clsx(styles.title)}>
					...
					<p>You acknowledge and agree that we provide access to such tools ”as is” and “as available” without
						...
						tools.</p>
					<p>Any use by you of the optional tools offered through the site is entirely at your own risk and
				...
				<div>
					...
					<p>If, at our request, you send certain specific submissions (for example contest entries) or
						...
						discretion to be unlawful, offensive, threatening, libelous, defamatory, pornographic, obscene
						or otherwise objectionable or violates any party’s intellectual property or these Terms of
						Service.
				...
				<div>
					...
					<p>
						...
						which can be viewed here: https://essera.store/policies/privacy-policy
					</p>
				</div>
				<div>
					<div className={clsx(styles.title)}>
				...
				<div>
					...
					<p>
						In no case shall ESSERA, our directors, officers, employees, affiliates, agents, contractors,
				...
				<div>
					...
					<p>
						You agree to indemnify, defend and hold harmless NAVI and our parent, subsidiaries, affiliates,
				...
				<div>
					...
					<p>
						...
						governs your use of the Service, superseding any prior or contemporaneous agreements,
				...
				<div>
					...
					<p>These Terms of Service and any separate agreements whereby we provide you Services shall be
						governed by and construed in accordance with the laws of United States.</p>
				</div>
				<div>
					<div className={clsx(styles.title)}>
				...
				<div>
					...
					<p>Questions about the Terms of Service should be sent to us at info@essera.store.</p>
					<p>Our contact information is posted below:</p>
					<p>ESSERA STORE</p>
					<p>info@essera.store</p>
				</div>
			</main>
		</div>
	);
